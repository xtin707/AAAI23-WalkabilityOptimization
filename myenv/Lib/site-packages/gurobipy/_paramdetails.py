...
param_details = {
    ...
    "PDHGGPU": {
        "description": "Important:\n\n  This feature is still considered *beta* in this release. This means\n  that we invite users to try this features, but the code didn\u2019t\n  undergo as much testing as the rest of the product.  This features\n  shouldn\u2019t be used in production settings, and the scope of technical\n  support is on a best-effort basis.\n\nBy default, the PDHG algorithm runs on the CPU. You can set this\nparameter to 1 to have PDHG run on the GPU instead, if your Gurobi\nbuild has GPU support and your system has compatible hardware. Note\nthat you must additionally set the Method parameter to\n\"GRB_METHOD_PDHG\" (6) to enable PDHG.\n\nNote:\n\n  PDHG only",
        "name": "PDHGGPU",
        "values": {
            "default": 0,
            "maximum": 1,
